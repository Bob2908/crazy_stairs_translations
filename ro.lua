...
module.gui.serversettings = {
	...
	["DroneUnCurse"] = "Dronele Repară scările Blocate",
	...
	["DroneCurse"] = "Șansă de creare de scară blocată (La Suta)",

	["Tower"] = "SETĂRI DE TURN",
	["TowerReadOnly"] = "SETĂRI DE TURN (nemodificabile)",
	["InfMode"] = "Mod Infinit (nu poate fi schimbat în timpul unei curse sau al unei regenerări)",
	["CasualPlayers"] = "Jucatori normali pot folosi abilitati",
	["Regeneration"] = "Regenerare de scări Automat dupa un Purge Lui Wicked (Nu va merge în modul infinit)",
	["EvenLevels"] = "Nivele Pare Restricționate",
	["OrbMoves"] = "Bila de sus iși schimbă posiția",
	["InfRegeneration"] = "Regenerare automată de scări pe server nou, Nivele de turn se schimbă si dupa concurs infinit ",
	--deprecated
	--["TowerLevels"] = "Tower levels (or active levels in the infinite mode). Cannot be changed during a race or a regeneration",
	["TowerSize"] = "Marime de grid la turn (experimental)",
	["RaceDuration"] = "Durație de concurs maxim. Nu va afecta concursul in momentul acesta. (secunde)",
	["InfStart"] = "Interval inițial de mod infinit (2 nivele sunt făcute fiecare rundă) (secunde)",
	["InfReduction"] = "Reductie de mod infinit (fiecare rundă este mai scurtă cu) (secunde)",
	["InfMin"] = "Duație minimă de interval la mod infinit (secunde)",

	--NEW KEY
	["CooldownTime"] = "Reâcărcare de event și Rig (secunde)",
	--END NEW
...
module.gui.shop = {
	...
	["3tokens"] = "Deschide o abilitate nouă sau folosește 3 ablităti super.",
	["30tokens"] = "Deschide 10 abilități noi sau folosește 30 de abilităti super",
	["300tokens"] = "Deajuns pentru a deschide toate abilităile din joc.",

	["3TOKENS"] = "3 Tokenuri Multi (R$%d)",
	["30TOKENS"] = "30 de Tokenuri Multi (R$%d)",
	["300TOKENS"] = "300 de Tokenuri Multi(R$%d)",

	--NEW
	["SPECTRE"] = "Gamepassul spectre (R$%d)",
	["MANA"] = "Gamepassul 20 de Energie (R$%d)",
	["CHAMELEON"] = "Gamepassul Chamelion (R$%d)",
	["ARCHITECT"] = "Gamepassul Architect (R$%d)",
...
module.gui.nospellsbar = {
	...
	["nocasual"] = "NUMAI CONCURENTII POT FOLOSI ABILITĂTI.",
	["possessed"] = "POSEDAT! (Găsește energie ca sa fii eliberat.)",
	--NEW
	["permanent"] = "POSEDAT! (Mod Permanent)",
	["cancelled"] = "ANULAT...", --timed spell cancelled
	--END NEW
...
module.gui.stats = {
	...
	["badges"] = "BADGURILE TALE",
	["climbs"] = "URCĂRILE TALE",
	["total"] = "URCĂRILE/CÂȘTIGURILE TALE",
	["best"] = "CEL MAI BUN TIMP",
	["norecord"] = "[nicun record]",

	["2124486274"] = "Prankuiește Creatorul",
	["1803533030753957"] = "Gaura Neagra",
	["2124480173"] = "Trădarea lui Wicked",
	["2124480172"] = "Trucul lui Joker",
	["2124637294"] = "Voyajul lui Drifter",
	["2124517579"] = "Heistul lui Thief",
	["4464785885277417"] = "Twistul lui Splicer",
	["2124480174"] = "Ordinea Lui Keeper",
	["2124637293"] = "Conecția lui Archon",
	["2124517578"] = "Exploitul lui Hacker",
	["707445818894757"] = "Spirala lui Gremlin",
	["2124480171"] = "Mândria Lui Patron",
	["1407551481032773"] = "Reflectia lui Reaver",
	["2124637295"] = "Blocarea lui Herectic",
	["1885715582646280"] = "Riteul Lui Necromancer",
	["2124480175"] = "Logica lui Muggle",
	["2124826874"] = "Cerc Complet",
	["2124529966"] = "Sărit Peste Tutorial",
	["2124826880"] = "Soarta Posedată",
	["3731010929572663"] = "Vis Hypnotisat",  
	["840574993122888"] = "Perspectiva Reflectata",
	["2124913225"] = "Designul Lui Architect",
	["2124702954"] = "Rootkit Instalat",
	["2124702945"] = "Distruge Totul",
	["2124702946"] = "Ordine Reparat",
	["128721686760593"] = "Mă Învârți Și Ma Învârți",
	["2124702952"] = "Voi Lua Liftul",
	["3121101516427751"] = "incurcarea",
	["2124702942"] = "Lasă 0 Noobi În Spate",
	["2124702950"] = "Illuminati Comfirmat",
	["2124702951"] = "Al meu, tot AL MEU!",
	["1165646024608180"] = "Noi suntem Unul.",
	["2303731210592278"] = "Vine, Vino, VINO!",
...
module.gui.questions = {
	["cancel"] = "Vrei să Stingi abilitatea asta de cronometru? Tokenurile nu vor fi date Înapoi.",
	["tutorial"]= "Vrei să Incepi Tutorialul?",
	["skip"] = "Vrei să sari peste tutorial?",
	["reshuffle"] = "Vrei ca scările să nu se unească? Dacă nu, orice scară care blochează va fi distrusă.",
...
module.gui.jukebox = {
	...
	["master"] = "VOLUM",
	["default"] = "(folosind volum)",
	["climb"] = "MUSICĂ DE URCARE",
	["endgame"] = "MUSICĂ DE SFÂRȘIT",
	["failed"] = "[Încărcare Eșuată]"
	--NEW
	["off"] = "MUTAT",
	--END NEW
}
...
module.gui.menu = {
	...
	["Music"] = "Musică",
	["RaceResults"] = "Rezultat la ultmul concurs",
	["ServerSettings"] = "Setări de Turn (Turn Costumizat)",
	["Settings"] = "Setări",
	["Shop"] = "Shop",
	["Spectate"] = "Spectate",
	["Stats"] = "Badgeurile Tale",
	["SwitchServer"] = "Schimbă Turnul",
	["Tokens"] = "Tokenurile tale",
	["Tutorial"] = "Tutorialul",
...
module.gui.tutorial = {
	...
	["complete"] = "AI CÂȘTIGAT!",
	["choose"] = "Te rog alege-ți Prima Clasă!",
...
local rig = "Asta este o abilitate rig. Va riga, 1 pe 1, fiecare scară cu " -- do not remove space
local event = "Asta Este o abilitate Event. Va afecta toate scările cu " -- do not remove space
local fill = "Asta Este o abilitate Fill. Ea va crea scări in fiecare intersecție goală. " -- do not remove spaces
